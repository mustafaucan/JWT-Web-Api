...
namespace Proje.JWT.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Authentication servis controlünün üzerinde olacak.
            services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme).AddJwtBearer(
                opt =>
                {
                    //localde http ile çalýþtýðýmýz için bunu kapatýyoruz.
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IAppUserService appUserService, IAppUserRoleService appUserRoleService, IAppRoleService appRoleService)
        {
            ...
            app.UseRouting();
            // Jwt Config ayarlarýný yaptýktan sonra app ile UseAuthenticationu kullanmamýz gereknzy.
